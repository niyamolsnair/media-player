...
await addVideoHistoryAPI(videoHistory)
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe className='w-100' width="1045" height="444" src={`${video?.link}?autoplay=1`} title={video?.caption} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
        </Modal.Body>
      </Modal>
